...
function ckFormatDateBC(date) {
	// if the date has already the new format, return the value
	if (date.indexOf(':') != -1 || date == '') return date;
...
function ckAddSlide(slide, position) {
	...
	// BC for dates
	startdate = ckFormatDateBC(startdate);
	enddate = ckFormatDateBC(enddate);
...
//					+'</div>'
	...
	+ '<div class="cksliderow">'
			...
			+ '<div class="cksliderow"><span class="ckslidelabel">' + Joomla.JText._('SLIDESHOWCK_STARTDATE', 'Start date') + '</span><input name="ckslidestartdate' + index + '" class="ckslidestartdate ckdatepickerold" type="datetime-local" value="' + startdate + '" /></div>'
			+ '<div class="cksliderow"><span class="ckslidelabel">' + Joomla.JText._('SLIDESHOWCK_ENDDATE', 'End date') + '</span><input name="ckslideenddate' + index + '" class="ckslideenddate ckdatepickerold" type="datetime-local" value="' + enddate + '" /></div>'
			+ '</div>'
			+ '</div></div>'
