DROP TABLE IF EXISTS `amn_action_log_config`;/*ABDE:amn_action_log_config*/
CREATE TABLE `amn_action_log_config` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_action_log_config*/
INSERT INTO `amn_action_log_config`  VALUES 
...
DROP TABLE IF EXISTS `amn_action_logs`;/*ABDE:amn_action_logs*/
CREATE TABLE `amn_action_logs` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_action_logs*/
DROP TABLE IF EXISTS `amn_action_logs_extensions`;/*ABDE:amn_action_logs_extensions*/
CREATE TABLE `amn_action_logs_extensions` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `extension` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_action_logs_extensions*/
INSERT INTO `amn_action_logs_extensions`  VALUES 
('1', 'com_banners'),
('2', 'com_cache'),
('3', 'com_categories'),
('4', 'com_config'),
...
('20', 'com_fields'),
('21', 'com_guidedtours');
DROP TABLE IF EXISTS `amn_action_logs_users`;/*ABDE:amn_action_logs_users*/
CREATE TABLE `amn_action_logs_users` (
  `user_id` int unsigned NOT NULL,
  `notify` tinyint unsigned NOT NULL,
  `extensions` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`user_id`),
  KEY `idx_notify` (`notify`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_action_logs_users*/
DROP TABLE IF EXISTS `amn_akeeba_common`;/*ABDE:amn_akeeba_common*/
CREATE TABLE `amn_akeeba_common` (
  `key` varchar(190) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `value` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`key`(100))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_akeeba_common*/
INSERT INTO `amn_akeeba_common`  VALUES 
...
DROP TABLE IF EXISTS `amn_akeebabackup_backups`;/*ABDE:amn_akeebabackup_backups*/
CREATE TABLE `amn_akeebabackup_backups` (
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_akeebabackup_backups*/
INSERT INTO `amn_akeebabackup_backups`  VALUES 
('1', 'Backup taken on 8. 9. 2026 23:30 UTC', '', '2026-09-08 23:30:50', '2026-09-08 23:30:50', 'complete', 'backend', 'dbonly', '1', 'site-localhost-20260908-233050utc-6f7oLs4H8BZKJi0a.sql', 'C:/Users/libor/Documents/GitHub/amnachod/administrator/components/com_akeebabackup/backup/site-localhost-20260908-233050utc-6f7oLs4H8BZKJi0a.sql', '0', 'backend', 'id-20260908-233049-911858', '1', NULL, '0', '0', '1');
DROP TABLE IF EXISTS `amn_akeebabackup_profiles`;/*ABDE:amn_akeebabackup_profiles*/
CREATE TABLE `amn_akeebabackup_profiles` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_akeebabackup_profiles*/
INSERT INTO `amn_akeebabackup_profiles`  VALUES 
...
DROP TABLE IF EXISTS `amn_akeebabackup_storage`;/*ABDE:amn_akeebabackup_storage*/
CREATE TABLE `amn_akeebabackup_storage` (
  `tag` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `lastupdate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `data` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`tag`(100))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_akeebabackup_storage*/
DROP TABLE IF EXISTS `amn_assets`;/*ABDE:amn_assets*/
CREATE TABLE `amn_assets` (
...
) ENGINE=InnoDB AUTO_INCREMENT=102 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_assets*/
INSERT INTO `amn_assets`  VALUES 
...
('101', '1', '185', '186', '1', 'com_akeebabackup', 'com_akeebabackup', '{}');
DROP TABLE IF EXISTS `amn_associations`;/*ABDE:amn_associations*/
CREATE TABLE `amn_associations` (
  ...
  KEY `idx_key` (`key`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_associations*/
DROP TABLE IF EXISTS `amn_banner_clients`;/*ABDE:amn_banner_clients*/
CREATE TABLE `amn_banner_clients` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_banner_clients*/
DROP TABLE IF EXISTS `amn_banner_tracks`;/*ABDE:amn_banner_tracks*/
CREATE TABLE `amn_banner_tracks` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_banner_tracks*/
DROP TABLE IF EXISTS `amn_banners`;/*ABDE:amn_banners*/
CREATE TABLE `amn_banners` (
  `id` int NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_banners*/
DROP TABLE IF EXISTS `amn_categories`;/*ABDE:amn_categories*/
CREATE TABLE `amn_categories` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  KEY `idx_language` (`language`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_categories*/
INSERT INTO `amn_categories`  VALUES 
...
DROP TABLE IF EXISTS `amn_contact_details`;/*ABDE:amn_contact_details*/
CREATE TABLE `amn_contact_details` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  KEY `idx_language` (`language`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_contact_details*/
DROP TABLE IF EXISTS `amn_content`;/*ABDE:amn_content*/
CREATE TABLE `amn_content` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_content*/
DROP TABLE IF EXISTS `amn_content_frontpage`;/*ABDE:amn_content_frontpage*/
CREATE TABLE `amn_content_frontpage` (
  `content_id` int NOT NULL DEFAULT '0',
  `ordering` int NOT NULL DEFAULT '0',
  `featured_up` datetime DEFAULT NULL,
  `featured_down` datetime DEFAULT NULL,
  PRIMARY KEY (`content_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_content_frontpage*/
DROP TABLE IF EXISTS `amn_content_rating`;/*ABDE:amn_content_rating*/
CREATE TABLE `amn_content_rating` (
  `content_id` int NOT NULL DEFAULT '0',
  `rating_sum` int unsigned NOT NULL DEFAULT '0',
  `rating_count` int unsigned NOT NULL DEFAULT '0',
  `lastip` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`content_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_content_rating*/
DROP TABLE IF EXISTS `amn_content_types`;/*ABDE:amn_content_types*/
CREATE TABLE `amn_content_types` (
...
) ENGINE=InnoDB AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_content_types*/
INSERT INTO `amn_content_types`  VALUES 
...
DROP TABLE IF EXISTS `amn_contentitem_tag_map`;/*ABDE:amn_contentitem_tag_map*/
CREATE TABLE `amn_contentitem_tag_map` (
  `type_alias` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Maps items from content tables to tags';/*ABDE:amn_contentitem_tag_map*/
DROP TABLE IF EXISTS `amn_extensions`;/*ABDE:amn_extensions*/
CREATE TABLE `amn_extensions` (
...
) ENGINE=InnoDB AUTO_INCREMENT=260 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_extensions*/
INSERT INTO `amn_extensions`  VALUES 
...
DROP TABLE IF EXISTS `amn_fields`;/*ABDE:amn_fields*/
CREATE TABLE `amn_fields` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  KEY `idx_language` (`language`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_fields*/
DROP TABLE IF EXISTS `amn_fields_categories`;/*ABDE:amn_fields_categories*/
CREATE TABLE `amn_fields_categories` (
  `field_id` int NOT NULL DEFAULT '0',
  `category_id` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`field_id`,`category_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_fields_categories*/
DROP TABLE IF EXISTS `amn_fields_groups`;/*ABDE:amn_fields_groups*/
CREATE TABLE `amn_fields_groups` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int unsigned NOT NULL DEFAULT '0',
  `context` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  ...
  KEY `idx_context` (`context`(191)),
  KEY `idx_language` (`language`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_fields_groups*/
DROP TABLE IF EXISTS `amn_fields_values`;/*ABDE:amn_fields_values*/
CREATE TABLE `amn_fields_values` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_fields_values*/
DROP TABLE IF EXISTS `amn_finder_filters`;/*ABDE:amn_finder_filters*/
CREATE TABLE `amn_finder_filters` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_finder_filters*/
DROP TABLE IF EXISTS `amn_finder_links`;/*ABDE:amn_finder_links*/
CREATE TABLE `amn_finder_links` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_finder_links*/
DROP TABLE IF EXISTS `amn_finder_links_terms`;/*ABDE:amn_finder_links_terms*/
CREATE TABLE `amn_finder_links_terms` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_finder_links_terms*/
DROP TABLE IF EXISTS `amn_finder_logging`;/*ABDE:amn_finder_logging*/
CREATE TABLE `amn_finder_logging` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_finder_logging*/
DROP TABLE IF EXISTS `amn_finder_taxonomy`;/*ABDE:amn_finder_taxonomy*/
CREATE TABLE `amn_finder_taxonomy` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int unsigned NOT NULL DEFAULT '0',
  `lft` int NOT NULL DEFAULT '0',
  `rgt` int NOT NULL DEFAULT '0',
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_finder_taxonomy*/
INSERT INTO `amn_finder_taxonomy`  VALUES 
('1', '0', '0', '1', '0', '', 'ROOT', 'root', '1', '1', '*');
DROP TABLE IF EXISTS `amn_finder_taxonomy_map`;/*ABDE:amn_finder_taxonomy_map*/
CREATE TABLE `amn_finder_taxonomy_map` (
  `link_id` int unsigned NOT NULL,
  `node_id` int unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`node_id`),
  KEY `link_id` (`link_id`),
  KEY `node_id` (`node_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_finder_taxonomy_map*/
DROP TABLE IF EXISTS `amn_finder_terms`;/*ABDE:amn_finder_terms*/
CREATE TABLE `amn_finder_terms` (
  ...
  KEY `idx_language` (`language`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_finder_terms*/
DROP TABLE IF EXISTS `amn_finder_terms_common`;/*ABDE:amn_finder_terms_common*/
CREATE TABLE `amn_finder_terms_common` (
  `term` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `language` char(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `custom` int NOT NULL DEFAULT '0',
  UNIQUE KEY `idx_term_language` (`term`,`language`),
  KEY `idx_lang` (`language`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_finder_terms_common*/
INSERT INTO `amn_finder_terms_common`  VALUES 
('a', 'cs', '0'),
('a', 'en', '0'),
('about', 'en', '0'),
('above', 'en', '0'),
...
('znovu', 'cs', '0'),
('že', 'cs', '0');
DROP TABLE IF EXISTS `amn_finder_tokens`;/*ABDE:amn_finder_tokens*/
CREATE TABLE `amn_finder_tokens` (
  `term` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `stem` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `common` tinyint unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint unsigned NOT NULL DEFAULT '0',
  ...
  KEY `idx_language` (`language`)
) ENGINE=MEMORY DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_finder_tokens*/
DROP TABLE IF EXISTS `amn_finder_tokens_aggregate`;/*ABDE:amn_finder_tokens_aggregate*/
CREATE TABLE `amn_finder_tokens_aggregate` (
  `term_id` int unsigned NOT NULL,
  `term` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `stem` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `common` tinyint unsigned NOT NULL DEFAULT '0',
...
) ENGINE=MEMORY DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_finder_tokens_aggregate*/
DROP TABLE IF EXISTS `amn_finder_types`;/*ABDE:amn_finder_types*/
CREATE TABLE `amn_finder_types` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `mime` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  UNIQUE KEY `title` (`title`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_finder_types*/
INSERT INTO `amn_finder_types`  VALUES 
('1', 'Category', ''),
('2', 'Contact', ''),
('3', 'Article', ''),
('4', 'News Feed', ''),
('5', 'Tag', '');
DROP TABLE IF EXISTS `amn_guidedtour_steps`;/*ABDE:amn_guidedtour_steps*/
CREATE TABLE `amn_guidedtour_steps` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  KEY `idx_state` (`published`),
  KEY `idx_language` (`language`)
) ENGINE=InnoDB AUTO_INCREMENT=118 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_guidedtour_steps*/
INSERT INTO `amn_guidedtour_steps`  VALUES 
...
DROP TABLE IF EXISTS `amn_guidedtours`;/*ABDE:amn_guidedtours*/
CREATE TABLE `amn_guidedtours` (
  `id` int NOT NULL AUTO_INCREMENT,
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  ...
  KEY `idx_language` (`language`),
  KEY `idx_uid` (`uid`(191))
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_guidedtours*/
INSERT INTO `amn_guidedtours`  VALUES 
...
DROP TABLE IF EXISTS `amn_history`;/*ABDE:amn_history*/
CREATE TABLE `amn_history` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_history*/
DROP TABLE IF EXISTS `amn_languages`;/*ABDE:amn_languages*/
CREATE TABLE `amn_languages` (
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_languages*/
INSERT INTO `amn_languages`  VALUES 
('1', '0', 'en-GB', 'English (en-GB)', 'English (United Kingdom)', 'en', 'en_gb', '', '', '', '', '1', '1', '2'),
('2', '100', 'cs-CZ', 'Czech (Čeština)', 'Čeština', 'cs', 'cs_cz', '', NULL, '', '', '1', '1', '1');
DROP TABLE IF EXISTS `amn_mail_templates`;/*ABDE:amn_mail_templates*/
CREATE TABLE `amn_mail_templates` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_mail_templates*/
INSERT INTO `amn_mail_templates`  VALUES 
...
DROP TABLE IF EXISTS `amn_menu`;/*ABDE:amn_menu*/
CREATE TABLE `amn_menu` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  KEY `idx_path` (`path`(100)),
  KEY `idx_language` (`language`)
) ENGINE=InnoDB AUTO_INCREMENT=107 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_menu*/
INSERT INTO `amn_menu`  VALUES 
...
DROP TABLE IF EXISTS `amn_menu_types`;/*ABDE:amn_menu_types*/
CREATE TABLE `amn_menu_types` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int unsigned NOT NULL DEFAULT '0',
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_menu_types*/
INSERT INTO `amn_menu_types`  VALUES 
('1', '0', 'mainmenu', 'Main Menu', 'The main menu for the site', '0', '1');
DROP TABLE IF EXISTS `amn_messages`;/*ABDE:amn_messages*/
CREATE TABLE `amn_messages` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_messages*/
DROP TABLE IF EXISTS `amn_messages_cfg`;/*ABDE:amn_messages_cfg*/
CREATE TABLE `amn_messages_cfg` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_messages_cfg*/
DROP TABLE IF EXISTS `amn_modules`;/*ABDE:amn_modules*/
CREATE TABLE `amn_modules` (
  `id` int NOT NULL AUTO_INCREMENT,
  `asset_id` int unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  ...
  KEY `idx_language` (`language`)
) ENGINE=InnoDB AUTO_INCREMENT=110 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_modules*/
INSERT INTO `amn_modules`  VALUES 
...
DROP TABLE IF EXISTS `amn_modules_menu`;/*ABDE:amn_modules_menu*/
CREATE TABLE `amn_modules_menu` (
  `moduleid` int NOT NULL DEFAULT '0',
  `menuid` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`moduleid`,`menuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_modules_menu*/
INSERT INTO `amn_modules_menu`  VALUES 
('1', '0'),
('2', '0'),
('3', '0'),
('4', '0'),
...
('108', '0'),
('109', '0');
DROP TABLE IF EXISTS `amn_newsfeeds`;/*ABDE:amn_newsfeeds*/
CREATE TABLE `amn_newsfeeds` (
  `catid` int NOT NULL DEFAULT '0',
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  KEY `idx_createdby` (`created_by`),
  KEY `idx_language` (`language`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_newsfeeds*/
DROP TABLE IF EXISTS `amn_overrider`;/*ABDE:amn_overrider*/
CREATE TABLE `amn_overrider` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_overrider*/
DROP TABLE IF EXISTS `amn_postinstall_messages`;/*ABDE:amn_postinstall_messages*/
CREATE TABLE `amn_postinstall_messages` (
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_postinstall_messages*/
INSERT INTO `amn_postinstall_messages`  VALUES 
...
DROP TABLE IF EXISTS `amn_privacy_consents`;/*ABDE:amn_privacy_consents*/
CREATE TABLE `amn_privacy_consents` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int unsigned NOT NULL DEFAULT '0',
  `state` int NOT NULL DEFAULT '1',
  `created` datetime NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `idx_user_id` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_privacy_consents*/
DROP TABLE IF EXISTS `amn_privacy_requests`;/*ABDE:amn_privacy_requests*/
CREATE TABLE `amn_privacy_requests` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_privacy_requests*/
DROP TABLE IF EXISTS `amn_redirect_links`;/*ABDE:amn_redirect_links*/
CREATE TABLE `amn_redirect_links` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_redirect_links*/
DROP TABLE IF EXISTS `amn_scheduler_logs`;/*ABDE:amn_scheduler_logs*/
CREATE TABLE `amn_scheduler_logs` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_scheduler_logs*/
DROP TABLE IF EXISTS `amn_scheduler_tasks`;/*ABDE:amn_scheduler_tasks*/
CREATE TABLE `amn_scheduler_tasks` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_scheduler_tasks*/
INSERT INTO `amn_scheduler_tasks`  VALUES 
...
DROP TABLE IF EXISTS `amn_schemaorg`;/*ABDE:amn_schemaorg*/
CREATE TABLE `amn_schemaorg` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_schemaorg*/
DROP TABLE IF EXISTS `amn_schemas`;/*ABDE:amn_schemas*/
CREATE TABLE `amn_schemas` (
  `extension_id` int NOT NULL,
  `version_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`extension_id`,`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_schemas*/
INSERT INTO `amn_schemas`  VALUES 
('247', '6.1.0-2026-03-13'),
('256', '9.4.0-20221011');
DROP TABLE IF EXISTS `amn_session`;/*ABDE:amn_session*/
CREATE TABLE `amn_session` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_session*/
DROP TABLE IF EXISTS `amn_tags`;/*ABDE:amn_tags*/
CREATE TABLE `amn_tags` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int unsigned NOT NULL DEFAULT '0',
  `lft` int NOT NULL DEFAULT '0',
  `rgt` int NOT NULL DEFAULT '0',
  ...
  KEY `idx_alias` (`alias`(100)),
  KEY `idx_language` (`language`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_tags*/
INSERT INTO `amn_tags`  VALUES 
('1', '0', '0', '1', '0', '', 'ROOT', 'root', '', '', '1', NULL, NULL, '1', '', '', '', '', '140', '2026-09-08 23:06:52', '', '140', '2026-09-08 23:06:52', '', '', '0', '*', '1', NULL, NULL);
DROP TABLE IF EXISTS `amn_template_overrides`;/*ABDE:amn_template_overrides*/
CREATE TABLE `amn_template_overrides` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_template_overrides*/
DROP TABLE IF EXISTS `amn_template_styles`;/*ABDE:amn_template_styles*/
CREATE TABLE `amn_template_styles` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `template` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `client_id` tinyint unsigned NOT NULL DEFAULT '0',
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_template_styles*/
INSERT INTO `amn_template_styles`  VALUES 
...
DROP TABLE IF EXISTS `amn_tuf_metadata`;/*ABDE:amn_tuf_metadata*/
CREATE TABLE `amn_tuf_metadata` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Secure TUF Updates';/*ABDE:amn_tuf_metadata*/
INSERT INTO `amn_tuf_metadata`  VALUES 
...
DROP TABLE IF EXISTS `amn_ucm_base`;/*ABDE:amn_ucm_base*/
CREATE TABLE `amn_ucm_base` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_ucm_base*/
DROP TABLE IF EXISTS `amn_ucm_content`;/*ABDE:amn_ucm_content*/
CREATE TABLE `amn_ucm_content` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Contains core content data in name spaced fields';/*ABDE:amn_ucm_content*/
DROP TABLE IF EXISTS `amn_update_sites`;/*ABDE:amn_update_sites*/
CREATE TABLE `amn_update_sites` (
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Update Sites';/*ABDE:amn_update_sites*/
INSERT INTO `amn_update_sites`  VALUES 
...
DROP TABLE IF EXISTS `amn_update_sites_extensions`;/*ABDE:amn_update_sites_extensions*/
CREATE TABLE `amn_update_sites_extensions` (
  `update_site_id` int NOT NULL DEFAULT '0',
  `extension_id` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`update_site_id`,`extension_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';/*ABDE:amn_update_sites_extensions*/
INSERT INTO `amn_update_sites_extensions`  VALUES 
('1', '247'),
('2', '248'),
('2', '255'),
('3', '24'),
('4', '259');
DROP TABLE IF EXISTS `amn_updates`;/*ABDE:amn_updates*/
CREATE TABLE `amn_updates` (
...
) ENGINE=InnoDB AUTO_INCREMENT=104 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Available Updates';/*ABDE:amn_updates*/
INSERT INTO `amn_updates`  VALUES 
...
DROP TABLE IF EXISTS `amn_user_keys`;/*ABDE:amn_user_keys*/
CREATE TABLE `amn_user_keys` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_user_keys*/
DROP TABLE IF EXISTS `amn_user_mfa`;/*ABDE:amn_user_mfa*/
CREATE TABLE `amn_user_mfa` (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int unsigned NOT NULL,
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  ...
  PRIMARY KEY (`id`),
  KEY `idx_user_id` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Multi-factor Authentication settings';/*ABDE:amn_user_mfa*/
DROP TABLE IF EXISTS `amn_user_notes`;/*ABDE:amn_user_notes*/
CREATE TABLE `amn_user_notes` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int unsigned NOT NULL DEFAULT '0',
  `catid` int unsigned NOT NULL DEFAULT '0',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_user_notes*/
DROP TABLE IF EXISTS `amn_user_profiles`;/*ABDE:amn_user_profiles*/
CREATE TABLE `amn_user_profiles` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Simple user profile storage table';/*ABDE:amn_user_profiles*/
INSERT INTO `amn_user_profiles`  VALUES 
('140', 'guidedtour.id.12', '{\"state\":\"skipped\"}', '0');
DROP TABLE IF EXISTS `amn_user_usergroup_map`;/*ABDE:amn_user_usergroup_map*/
CREATE TABLE `amn_user_usergroup_map` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_user_usergroup_map*/
INSERT INTO `amn_user_usergroup_map`  VALUES 
('140', '8');
DROP TABLE IF EXISTS `amn_usergroups`;/*ABDE:amn_usergroups*/
CREATE TABLE `amn_usergroups` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_usergroups*/
INSERT INTO `amn_usergroups`  VALUES 
('1', '0', '1', '18', 'Public'),
('2', '1', '8', '15', 'Registered'),
('3', '2', '9', '14', 'Author'),
('4', '3', '10', '13', 'Editor'),
...
('9', '1', '2', '3', 'Guest');
DROP TABLE IF EXISTS `amn_users`;/*ABDE:amn_users*/
CREATE TABLE `amn_users` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  KEY `idx_block` (`block`),
  KEY `email` (`email`)
) ENGINE=InnoDB AUTO_INCREMENT=141 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_users*/
INSERT INTO `amn_users`  VALUES 
...
DROP TABLE IF EXISTS `amn_viewlevels`;/*ABDE:amn_viewlevels*/
CREATE TABLE `amn_viewlevels` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int NOT NULL DEFAULT '0',
  `rules` varchar(5120) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.',
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_viewlevels*/
INSERT INTO `amn_viewlevels`  VALUES 
('1', 'Public', '0', '[1]'),
('2', 'Registered', '2', '[6,2,8]'),
('3', 'Special', '3', '[6,3,8]'),
('5', 'Guest', '1', '[9]'),
('6', 'Super Users', '4', '[8]');
DROP TABLE IF EXISTS `amn_webauthn_credentials`;/*ABDE:amn_webauthn_credentials*/
CREATE TABLE `amn_webauthn_credentials` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_webauthn_credentials*/
DROP TABLE IF EXISTS `amn_workflow_associations`;/*ABDE:amn_workflow_associations*/
CREATE TABLE `amn_workflow_associations` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_workflow_associations*/
DROP TABLE IF EXISTS `amn_workflow_stages`;/*ABDE:amn_workflow_stages*/
CREATE TABLE `amn_workflow_stages` (
  `id` int NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_workflow_stages*/
INSERT INTO `amn_workflow_stages`  VALUES 
('1', '57', '1', '1', '1', 'COM_WORKFLOW_BASIC_STAGE', '', '1', NULL, NULL, NULL);
DROP TABLE IF EXISTS `amn_workflow_transitions`;/*ABDE:amn_workflow_transitions*/
CREATE TABLE `amn_workflow_transitions` (
  `id` int NOT NULL AUTO_INCREMENT,
  `asset_id` int DEFAULT '0',
  `ordering` int NOT NULL DEFAULT '0',
  `workflow_id` int NOT NULL,
  ...
  KEY `idx_workflow_id` (`workflow_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_workflow_transitions*/
INSERT INTO `amn_workflow_transitions`  VALUES 
...
DROP TABLE IF EXISTS `amn_workflows`;/*ABDE:amn_workflows*/
CREATE TABLE `amn_workflows` (
  `id` int NOT NULL AUTO_INCREMENT,
  `asset_id` int DEFAULT '0',
  `published` tinyint NOT NULL DEFAULT '0',
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  KEY `idx_checked_out` (`checked_out`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;/*ABDE:amn_workflows*/
INSERT INTO `amn_workflows`  VALUES 
